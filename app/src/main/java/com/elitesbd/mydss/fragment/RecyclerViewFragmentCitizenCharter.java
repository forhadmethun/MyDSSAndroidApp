 ...
 */
public class RecyclerViewFragmentCitizenCharter extends Fragment {

    public static RecyclerViewFragmentCitizenCharter newInstance() {
        RecyclerViewFragmentCitizenCharter recyclerViewFragment = new RecyclerViewFragmentCitizenCharter();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       List<Data> datas = ListItem.getListDataOfCiizenCharter();
